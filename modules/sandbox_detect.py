...
def get_last_input():
    ...
    return run_time - struct_lastinputinfo.dwTime
...
def detect_sandbox():
    ...
    if last_input >= max_input_threshold:
        return "[!] Exited: idle too long → suspicious"
